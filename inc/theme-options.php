...
<li><i class="fa fa-camera-retro"></i> FontAwesome示例</li>
    ...
    */
    ...
    array(
        'name' => '纪念日设置',
        'desc' => '每年固定时间开启黑白模式缅怀逝去的生命，默认开启06-04和07-13。留空则为禁用<br>
...
07-13 I have no enemies, and no hatred.|'
    ),
    array(
        'title' => '主题侧边栏跟随设置',
        'type' => 'subtitle'
    ...
    <div class="wrap">
        ...
        <form method="post">
                            ...
                            <td>
                                <label>
                                    <input name="<?php echo $value['id']; ?>" class="regular-text"
                                           ...
                                           value="<?php if ($optionsSetup || get_option($value['id']) != '') {
            ...
            <div class="panel" id="about_theme">
                <h2>主题的那些事</h2>
                <p>
                    &nbsp;&nbsp;这款主题一开始来自于大前端的D8主题，优秀的D8主题在经过欲思这里，欲思对这款主题进行了大量的修改，对本款主题的发展起到了非常重要的作用。</p>
                ...
                <p>
                    &nbsp;&nbsp;故，在经过多次修改后，自觉主题修改的足够完整，更名以将其与欲思主题以区分，并且将其代码托管至<a
                            href="https://coding.net/u/googlo/p/Git/git" target="_blank">Coding</a>，并且将其更名为：Git ！
                </p>
                <p>
                    &nbsp;&nbsp;定名为Git，首先是因为主题采用Git版本系统管理代码的，写的最多的代码就是Git了，另外G代表我的Googlo.Me，遂定名为Git。</p>
                <p>
                    &nbsp;&nbsp;感谢大前端的D8主题，感谢欲思的欲思主题，感谢小影的主题，感谢知更鸟的主题，感谢露兜博客，感谢devework，感谢开源中国，感谢一直跟随主题版本升级的朋友们</p>
                <h2>支持云落</h2>
                <p>如果您觉的这款主题很赞，欢迎您扫码支持云落，<font
                            color="#ff0000">PS.主题不会用，扫码之后联系云落QQ</font></p>
