            ...
            while (have_posts()):
                ...
                <header class="article-header">
                    ...
                    <div class="meta">
                        ...
                        <?php
                        if (git_get_option('git_baidurecord_b') && function_exists('curl_init')) { ?><span
                                class="muted"><i class="fa fa-flag"></i> <?php
                        ...
                        <?php
                        if (git_get_option('git_qr_b') && !bt_is_mobile()) { ?><span class="muted"><i
                                    class="fa fa-qrcode"></i> <a style="cursor : pointer;"
                                                                 onMouseOver="document.all.qr.style.visibility=''"
				...
				<span id="qr" style="visibility: hidden;"><img style="position:absolute;z-index:99999;"
                                                               src="https://pan.baidu.com/share/qrcode?w=145&h=145&url<?php
			...
			<div class="product-detail">
                ...
                <article class="article-content">
                    ...
                    <div class="article-social">
                        ...
                        if (isset($_COOKIE['bigfa_ding_' . $post->ID])) echo ' actived'; ?>"><i
                                    class="fa fa-heart-o"></i>喜欢 (<span class="count"><?php
                        ...
                        if (git_get_option('git_bdshare_b'))
                            //echo '<span class="or"><style>.article-social .weixin:hover{background:#fff;}</style><a class="weixin" style="border-bottom:0px;font-size:15pt;cursor:pointer;">赏<div class="weixin-popover"><div class="popover bottom in"><div class="arrow"></div><div class="popover-title"><center>[' . git_get_option('git_pay') . ']</center></div><div class="popover-content"><img width="200px" height="200px" src="' . git_get_option('git_pay_qr') . '" ></div></div></div></a></span>';
                            echo '';
                        deel_share(); ?>
                    </div>
                </article>
...
<span class="social-icon-wrap"><a class="as-img as-home" target="_blank" href="<?php
    the_author_meta('url'); ?>" title="作者主页"><i class="fa fa-home"></i>作者主页</a></span>
                                ...
                                <span class="social-icon-wrap"><a class="as-img as-email" target="_blank"
                                                                  href="mailto:<?php
