...
<head>
    ...
    <?php if ('样式1' == git_get_option('git_cursor_b') && !bt_is_mobile()): ?>
        <style type="text/css">
            html {
                cursor: url(<?= get_template_directory_uri().'/css/cursor/default1.cur'; ?>), default;
            }

            a {
                cursor: url(<?= get_template_directory_uri().'/css/cursor/pointer1.cur'; ?>), pointer;
            }
    ...
    <?php elseif ('样式2' == git_get_option('git_cursor_b') && !bt_is_mobile()): ?>
        <style type="text/css">
            html {
                cursor: url(<?= get_template_directory_uri().'/css/cursor/default2.cur'; ?>), default;
            }

            a {
                cursor: url(<?= get_template_directory_uri().'/css/cursor/pointer2.cur'; ?>), pointer;
            }
    ...
    <?php endif; ?>
    <link href="<?= get_template_directory_uri(); ?>/css/font-awesome.min.css" rel="stylesheet" media="none"
                ...
                <?php
                    ...
                    <form method="get" class="searchform themeform"
                        ...
                        <div><input type="ext" class="search" name="s" onblur="if(this.value=='')this.value='<?php
                            echo git_get_option('git_search_placeholder', '输入内容并回车'); ?>';"
                                    onfocus="if(this.value=='<?php
                                    echo git_get_option('git_search_placeholder', '输入内容并回车'); ?>')this.value='';"
                                    value="<?php
