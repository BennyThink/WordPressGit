...
echo esc_url(get_template_directory_uri()); ?>/css/img/footbg.jpg'); background-repeat: repeat;" class="footer">
    <div class="footer-inner">
        <div class="footer-copyright" align="center"><?php
            if (git_get_option('git_footcode')) echo git_get_option('git_footcode'); ?> <span
                    class="yunluocopyright"><?php if (function_exists('performance')) performance(true); ?></span>
            <br>

            <?php if (git_get_option('git_weixin_qr')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-wechat fa-stack-1x" href="<?php echo git_get_option('git_weixin_qr') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_qqContact')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-qq fa-stack-1x"
                   href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo git_get_option('git_qqContact') ?>&site=qq&menu=yes"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_weibo')): ?><span class="fa-stack fa-lg">
                <a class="fa fa-weibo fa-stack-1x" href="<?php echo git_get_option('git_weibo') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>

            <?php if (git_get_option('git_emailContact')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-envelope-o fa-stack-1x"
                   href="<?php echo 'mailto:' . git_get_option('git_emailContact') ?>" target="view_window"></a>
                </span><?php endif; ?>

            <?php if (git_get_option('git_twitter')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-twitter fa-stack-1x" href="<?php echo git_get_option('git_twitter') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_facebook')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-facebook fa-stack-1x" href="<?php echo git_get_option('git_facebook') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_googleplus')) : ?><span class="fa-stack fa-lg">
                <a class="fa fa-google-plus fa-stack-1x" href="<?php echo git_get_option('git_googleplus') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>

            <?php if (git_get_option('git_instagram')): ?><span class="fa-stack fa-lg">
                <a class="fa fa-instagram fa-stack-1x" href="<?php echo git_get_option('git_instagram') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_git')): ?><span class="fa-stack fa-lg">
                <a class="fa fa-github fa-stack-1x" href="<?php echo git_get_option('git_git') ?>"
                   target="view_window"></a>
                </span><?php endif; ?>
            <?php if (git_get_option('git_telegram')): ?><span class="fa-stack fa-lg">
                <a class="fa fa-telegram fa-stack-1x"
                   href="<?php echo 'https://t.me/' . git_get_option('git_telegram') ?>" target="view_window"></a>
                </span><?php endif; ?>
